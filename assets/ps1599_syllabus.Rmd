...
<!--------------- Break --------------->
## `r advdate(mon, 7)`: Research workshop
...
<!--------------- Break --------------->
## `r advdate(mon, 8)`: Research workshop
...
<!--------------- Break --------------->
## `r advdate(mon, 11)`. Policy workshop
...
<!--------------- Break --------------->
## `r advdate(mon, 12)`. Demand failures -- social dynamics
